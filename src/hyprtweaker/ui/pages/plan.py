...
def is_visible(
    ...
    *,
    ...
    visit, exempt from the switch and from the tier rule alike. It is a parameter rather
    than a flag on the Option because the exemption belongs to *this* rebuild -- an Option
    that carried its own "revealed" bit would stay revealed until something thought to
    clear it, which is the state ADR-0017 rejected temporary visibility modes to avoid.
    """
