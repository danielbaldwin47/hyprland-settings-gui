...
Schema loading, the config model, the writer, the apply pipeline, the
importers, IPC and on-disk state all live here. Nothing under this package may import ``gi``
